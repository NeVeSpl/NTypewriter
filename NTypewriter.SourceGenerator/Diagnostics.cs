...
namespace NTypewriter.SourceGenerator
{
    internal static class Diagnostics
    {
        ...
        public static readonly DiagnosticDescriptor TouchInfo = new DiagnosticDescriptor("NTSG002", "NTypewriter.SourceGenerator::TouchInfo", "{0}", "Design", DiagnosticSeverity.Info, true);
